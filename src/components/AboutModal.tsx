...
export default function AboutModal({ isOpen, onClose }: AboutModalProps) {
    ...
    const lifeFocusPillars = [
        { icon: Heart, name: "Core", desc: "Soul, purpose, being", color: "from-rose-500 to-pink-500" },
        { icon: Sparkles, name: "Body", desc: "Health, mind, energy", color: "from-purple-500 to-indigo-500" },
        { icon: Users, name: "People", desc: "Family, friends, love", color: "from-blue-500 to-cyan-500" },
        { icon: Briefcase, name: "Work", desc: "Career, responsibility", color: "from-gray-600 to-gray-800" },
        { icon: TrendingUp, name: "Grow", desc: "Skills, business, learning", color: "from-emerald-500 to-green-500" },
        { icon: Globe, name: "Give", desc: "Community, impact", color: "from-teal-500 to-cyan-600" },
        { icon: Target, name: "Play", desc: "Joy, travel, rest", color: "from-yellow-500 to-orange-500" },
        { icon: Lightbulb, name: "Learn", desc: "Knowledge, wisdom", color: "from-amber-500 to-yellow-600" },
        { icon: Flame, name: "Life", desc: "The unexpected", color: "from-red-500 to-orange-600" },
    ];
                            ...
                            <div className="max-w-3xl">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                                    <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50 to-pink-50 border border-purple-100">
                                        ...
                                        <div className="text-sm font-bold text-gray-700 mb-2">Daily Capacity</div>
                                        <div className="text-xs text-gray-600">Every day ends with one question: Did you use your 1440 minutes well?</div>
                                    </div>
                                    <div className="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-100">
                                        <div className="text-4xl font-black text-blue-600 mb-2">Log</div>
                                        <div className="text-sm font-bold text-gray-700 mb-2">Time Reports</div>
                                        <div className="text-xs text-gray-600">See your active time, focus time, and where your attention went.</div>
                                    </div>
                                    <div className="p-6 rounded-2xl bg-gradient-to-br from-green-50 to-emerald-50 border border-green-100">
                                        ...
                                        <div className="text-xs text-gray-600">Time isn't "bad", it's just spent. Want different results? Spend differently.</div>
                                    </div>
                                </div>
                        ...
                        >
                            <div className="max-w-4xl w-full">
                                <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full mb-6">
                                    ...
                                    <span className="text-sm font-bold text-purple-600">Focus Areas</span>
                                </div>
                                <h2 className="text-5xl font-black mb-6">
                                    Your life in
                                    <br />
                                    <span className="bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">9 Areas.</span>
                                </h2>
                                <p className="text-xl text-gray-600 mb-12 leading-relaxed">
                                    Every moment fits somewhere. Track it simply.
                                </p>
